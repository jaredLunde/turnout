...
func NewNetlifySignal(filesystem filesystems.FileSystem) *NetlifySignal {
...
func (n *NetlifySignal) ObserveEntry(ctx context.Context, rootPath string, entry filesystems.DirEntry) error {
